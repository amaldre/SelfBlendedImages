...
def init_ff(phase, level='frame',n_frames=8):
	dataset_path='/home/alicia/datasets/FaceForensics++/frames/'
	...
	folder_list = file_to_list(os.path.join(TXT_DIR, "ff++_frames_dir.txt"))
	filelist = []
	list_dict = json.load(open(f'/home/alicia/datasets/FaceForensics++/{phase}.json','r'))
	for i in list_dict:
		filelist+=i
	...
	for i in range(len(folder_list)):
		...
		images_temp=sorted(glob(os.path.join(dataset_path, folder_list[i])+'/*.png'))
...
def init_MSU_MFD(phase, n_frames):
	...
	#dataset_frames_path = '/home/alicia/datasets/MSU-MFSD/frames'
	dataset_frames_path = '/home/alicia/datasets/new_yunetonly_dataset/msu-mfsd/frames'
...
def init_replay_attack(phase, n_frames):
	assert phase in ["train", "val"]
	val_names = file_to_list(os.path.join(TXT_DIR, "replay-attack_val_split.txt"))
	train_names = file_to_list(os.path.join(TXT_DIR, "replay-attack_train_split.txt"))
	#dataset_frames_path = '/home/alicia/datasets/replay-attack/frames'
	dataset_frames_path = '/home/alicia/datasets/new_yunetonly_dataset/replay-attack/frames'
...
def init_mobio(phase, n_frames):
	...
	#dataset_frames_path = '/home/alicia/datasets/mobio/frames'
	dataset_frames_path = '/home/alicia/datasets/new_yunetonly_dataset/mobio/frames'
	all_video_names = os.listdir(dataset_frames_path)
...
def init_sim_mw2(phase, n_frames):
	...
	#dataset_frames_path = '/home/alicia/datasets/sim-mv2/frames'
	dataset_frames_path = '/home/alicia/datasets/new_yunetonly_dataset/sim-mv2/frames'
	folder_list = []
	image_list = []
	label_list = []
	all_video_names = os.listdir(dataset_frames_path)
